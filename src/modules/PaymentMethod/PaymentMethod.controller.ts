...
class PaymentMethodController {
    ...
    async findOne(req: Request, res: Response): Promise<void> {
        try {
            ...
            const paymentMethod = await PaymentMethodServices.findOne(Number(idPaymentMethod));
    ...
    async update(req: Request, res: Response): Promise<void> {
        try {
            const body: PaymentMethod = req.body
            const {idPaymentMethod} = req.params
            const paymentMethod = await PaymentMethodServices.update(Number(idPaymentMethod), body);
            res.json(paymentMethod)
        } catch (error) {
            res.json(error)
        }
    ...
    async delete(req: Request, res: Response): Promise<void> {
        try {
            const {idPaymentMethod} = req.params
            const paymentMethod = await PaymentMethodServices.delete(Number(idPaymentMethod));
            res.json(paymentMethod)
        } catch (error) {
            res.json(error)
        }
