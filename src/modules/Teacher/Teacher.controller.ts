...
class TeacherController {
    ...
    async assignLevelToTeacher(req: Request, res: Response): Promise<void> {
        try {
            ...
            const teacher = await TeacherService.assignLevelToTeacher(Number(idTeacher), Number(idLevel));
            res.json(teacher)
        } catch (error) {
            res.json(error)
        }
    ...
    async assignUnitToTeacher(req: Request, res: Response): Promise<void> {
        try {
            ...
            const teacher = await TeacherService.assignUnitToTeacher(Number(idTeacher), Number(idUnit));
            res.json(teacher)
        } catch (error) {
            res.json(error)
        }
    ...
    async assignCourseToTeacher(req: Request, res: Response): Promise<void> {
        try {
            ...
            const teacher = await TeacherService.assignCourseToTeacher(Number(idTeacher), Number(idCourse));
            res.json(teacher)
        } catch (error) {
            res.json(error)
        }
    ...
    async assignModuleToTeacher(req: Request, res: Response): Promise<void> {
        try {
            ...
            const teacher = await TeacherService.assignModuleToTeacher(Number(idTeacher), Number(idModule));
            res.json(teacher)
        } catch (error) {
            res.json(error)
        }
