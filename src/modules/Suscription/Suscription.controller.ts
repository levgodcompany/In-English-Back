...
class SuscriptionController {
  ...
  async assignStudentToSuscription(req: Request, res: Response): Promise<void> {
    try {
      ...
      const suscription = await SuscriptionService.assignStudentToSuscription(
        Number(idSuscription),
        Number(idStudent)
      );
      res.json(suscription);
  ...
  async assignBenefitToSuscription(req: Request, res: Response): Promise<void> {
    try {
      ...
      const suscription = await SuscriptionService.assignBenefitToSuscription(
        Number(idSuscription),
        Number(idBenefit)
      );
      res.json(suscription);
  ...
  async assignBenefitsToSuscription(
    ...
    try {
      ...
      const suscription = await SuscriptionService.assignBenefitsToSuscription(
        Number(idSuscription),
  ...
  async assignPaymentMethodToSuscription(
    ...
    try {
      ...
      const suscription =
        await SuscriptionService.assignPaymentMethodToSuscription(
          Number(idSuscription),
  ...
  async assignPaymentMethodsToSuscription(
    ...
    try {
      ...
      const suscription =
        await SuscriptionService.assignPaymentMethodsToSuscription(
          Number(idSuscription),
